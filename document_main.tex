...
\begin{titlepage}
    ...
    \includegraphics[width=0.2\textwidth]{images/cover_page_logo.png}\\
    
    % Decorative Line
    {\color{black!60}\rule{0.8\textwidth}{2pt}}\\[1cm]
    
    % Project Title
    {\Huge \textbf{zGate Gateway}}\\[0.3cm]
    {\LARGE {A Zero Trust Database Access Proxy}\\[0.7cm]
    
    % Decorative Line
    {\color{black!60}\rule{0.8\textwidth}{2pt}}\\[1.2cm]
