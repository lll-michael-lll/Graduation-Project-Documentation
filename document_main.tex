...
\renewcommand{\LettrineFontHook}{\color{darkNavy}\bfseries}
...
% -----------------------------
% Lettrine switch for chapter intros
% -----------------------------
\newif\ifapplylettrine
\applylettrinefalse

\newcommand{\lettrineSwitch}{\applylettrinetrue}
...
\def\par{%
  \ifapplylettrine
    \applylettrinefalse
    \let\par\oldpar
    \expandafter\handleLettrine
  \else
    \oldpar
  \fi
}

\def\handleLettrine#1#2 {%
  \lettrine[lines=3,lhang=0.1,nindent=0em,findent=0.3em,loversize=0.15]{\color{darkNavy}\textbf{#1}}{#2} %
}
