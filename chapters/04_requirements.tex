...
\begin{sectionintro}{4}{Requirements Engineering}{
  \begin{itemize}[leftmargin=1.5em]
    \item Functional requirements for system components
    \item Non-functional requirements and performance targets
    \item Permission system and access control
    \item System actors and use cases
  \end{itemize}
}
...
\begin{itemize}
    \item Multi-database support (MSSQL, MySQL, PostgreSQL)
...
\textbf{Key Metrics:}
\begin{itemize}
    \item Access token expiry: 5 minutes
    \item Refresh token expiry: 1 day
