...
\begin{itemize}
    ...
    \item \textbf{Architecture Design:} Defined the ``Man-in-the-Middle'' architecture required to intercept binary wire protocols for MySQL, PostgreSQL, and MongoDB.
