...
\begin{sectionintro}{17}{Milestones}{
  \begin{itemize}[leftmargin=1.5em]
    \item Term~1 milestone achievements
    \item Term~2 planned milestones and deliverables
    \item Progressive system development phases
    \item Feature implementation timeline
    \item Validation and deployment milestones
  \end{itemize}
}
\lettrine[lines=3, lhang=0.1, loversize=0.15]{\color{primaryBlue}M}{ilestones structure the development journey into concrete}, measurable achievements. This chapter outlines the six critical milestones that guide zGate from initial research through production deployment. The first three milestones, completed in Term~1, established the architectural foundation and delivered a working proof of concept. The remaining milestones focus on advanced security features, governance, and comprehensive validation.
\end{sectionintro}
