...
\begin{longtable}{|p{1.6cm}|p{4.0cm}|p{\dimexpr\linewidth-1.6cm-4.0cm-6\tabcolsep-4\arrayrulewidth\relax}|}
...
\hline
\endfirsthead
\multicolumn{3}{l}{\footnotesize\itshape (Continued from previous page)} \\[2pt]
\hline
\rowcolor{lightGray}
\textbf{Control} & \textbf{Family} & \textbf{zGate Implementation} \\
\hline
