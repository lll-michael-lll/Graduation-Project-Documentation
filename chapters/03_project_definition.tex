...
\begin{itemize}
    ...
    % Temporary credential lifecycle is documented elsewhere; removed inline to avoid duplication
...
Built with Next.js 15, React 19, and Radix UI, the dashboard provides comprehensive management capabilities:
\begin{itemize}
