...
\textbf{Decision:} MySQL with AES-256-GCM encryption for sensitive data.

\textbf{Rationale:}
\begin{itemize}
    \item MySQL: Row-level locking (InnoDB) required for safe shared-account concurrency model
